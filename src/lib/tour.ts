...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    id: "chat-freeze",
    text:
      "Ты попал в чат с Дарителем — и в этот момент у тебя «заморозился» 1 подарочный балл 🔒",
    cta: "Понятно",
  },
  {
    id: "chat-templates",
  ...
  },
  {
    id: "profile-xp",
    text:
      "Уровень повышается при накоплении Опыта, который начисляется за каждое активное действие в сервисе.",
    cta: "Ок",
  },
  {
    id: "profile-balance",
  ...
  },
  {
    id: "chats-reviews",
    text:
      "Здесь ты найдёшь свои переписки с актуальными Дарителями и Получателями, а также архивные. О каждом взаимодействии нужно оставить отзыв — быстрый или развёрнутый (развёрнутый даёт больше опыта).",
    cta: "Договорились",
  },
  {
    id: "chats-admin",
