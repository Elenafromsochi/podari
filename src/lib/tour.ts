...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    text:
      "Ты можешь отправить шаблонное сообщение, нажав на кнопку, либо задать свой вопрос дарителю.\n\n👉 Сделай это прямо сейчас, а потом жми «Готово».",
    cta: "Готово",
  },
  {
    id: "chat-decline",
  ...
  },
  {
    ...
    text:
      "Опиши подарок удобным способом: добавь фото — ИИ сам сделает описание, или напиши пару слов и нажми «✨ Дополнить с ИИ». Сделай это прямо сейчас и жми «Готово».",
    cta: "Готово",
  },
  {
    id: "give-cost",
