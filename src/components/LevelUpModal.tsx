...
const LEVELS: Record<number, LevelMeta> = {
  2: {
    ...
    subtitle: "Встречи и знакомства вживую",
    unlocks:
      "Кофе, прогулка, пробежка, настолки, баня, велозаезд — позови кого-то провести время в хорошей компании. По-дружески, не только романтика.",
    image: level2Img,
  ...
  4: {
    emoji: "🏅",
    title: "Надёжный даритель — это ты!",
    subtitle: "Сообщество тебе доверяет",
    unlocks:
      "Значок доверия в профиле, тебя охотнее выбирают, а твои подарки разбирают быстрее. Ты стал примером для новичков 💚",
    accent: "bg-peach",
  },
  5: {
    emoji: "👑",
    title: "Хранитель тепла — вершина!",
    subtitle: "Высшее признание сообщества",
    unlocks:
      "Корона в профиле, особый статус и почёт в «Подари». Спасибо, что несёшь добро и делаешь людям день 👑",
    accent: "bg-lavender",
  },
};
