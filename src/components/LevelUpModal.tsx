...
const LEVELS: Record<number, LevelMeta> = {
  2: {
    emoji: "💆",
    title: "2 уровень открыт!",
    subtitle: "Теперь тебе доступны подарки — время специалиста",
    unlocks:
      "Кофе вдвоём, прогулка, маникюр, массаж, стрижка — то, что не вещь, а внимание.",
    image: level2Img,
  ...
  3: {
    emoji: "🎭",
    title: "3 уровень открыт!",
    subtitle: "Теперь тебе доступны угощения и мероприятия",
    unlocks:
      "Обед, концерт, театр, выставка, день рождения — приглашения, которые делают день особенным.",
    image: level3Img,
  ...
  4: {
    emoji: "✨",
    title: "4 уровень открыт!",
    subtitle: "Подарки стоимостью до 6 000 ₽",
    unlocks: "Открылась новая категория подарков более высокой ценности.",
    accent: "bg-peach",
  },
  5: {
    emoji: "👑",
    title: "5 уровень открыт!",
    subtitle: "Премиум-время специалиста",
    unlocks: "Доступно время специалиста более высокой стоимости — до 6 000 ₽.",
    accent: "bg-lavender",
  },
};
