...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    text: "Когда подаришь — баланс восстановится, а ты получишь +20 опыта за публикацию и ещё +80 за встречу.",
    placement: "bottom",
  },
  {
    selector: '[data-coach="cabinet"]',
    title: "Шаг 3 — следи за прогрессом ✨",
    text: "В личном кабинете видны опыт, уровни и баллы. Нажми на «?» рядом с цифрой — там всё объяснено.",
    placement: "top",
  },
];
